<aside class="left-sidebar">
            ...
            <div class="sidebar-footer">
                ...
                <!-- item--><a href="" class="link" data-toggle="tooltip" title="Logout" onclick="event.preventDefault();document.getElementById('logout-form').submit()"><i class="mdi mdi-power"></i></a>
