...
<div class="row">
    <div class="col-md-12">
         <div class="card-body">
            <form method="post" action="{{route("teacher.cq.store")}}" enctype="multipart/form-data">
                @csrf 
                <input type="hidden" name="exam_id" value="{{$exam->id}}">
                 <div class="row form-group">
                    <label for="" class="col-md-2">Upload Question:</label>
                    <div class="col-md-10">
                        <input type="file" accept="application/pdf" name="question" required class="form-control">
                        @error("question")
