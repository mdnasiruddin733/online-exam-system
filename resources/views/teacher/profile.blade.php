...
<div class="row">
        ...
        <div class="card">
            <div class="card-block">
                ...
                <center class="m-t-30"> <img src="{{asset(auth()->user()->image)}}" class="img-circle" width="150" id="profile-image">
                    ...
                    <a href="{{route('teacher.change-password')}}" class="btn btn-primary btn-block text-white">Change Password </a>
                </center>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
        <div class="card">
            <div class="card-block">
                <form class="form-horizontal form-material" method="POST" action="{{route("teacher.update-profile")}}">
                    @csrf
...
<script>
    $("#change-image").click(function(){
        ...
        $("#image-input").change(function(e){
            ...
            $.ajax({
                type:"POST",
                url:"{{route('teacher.change-profile-image')}}",
                processData:false,
                contentType:false,
                data:formdata,
