...
<div class="row">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <center class="m-t-30"> 
                    <img src="{{asset(asset($department->image))}}" class="img-circle" width="150" id="profile-image">
                </center>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
        <div class="card">
            <div class="card-block">
                <form class="form-horizontal form-material" method="POST" action="{{route("admin.department.update")}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{$department->id}}">
                    <div class="form-group row">
                        <label class="col-md-4">Department Name</label>
                        <div class="col-md-8">
                            <input type="text" placeholder="" class="form-control form-control-line" name="name" value="{{$department->name}}">
                            @error("name")
