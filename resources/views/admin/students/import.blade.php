...
@section("breadcrumb")
    ...
    <li class="breadcrumb-item active">Import Students From Excel</li>
@endsection
...
<div class="row mx-auto">
    <div class="col-md-12 mb-4 text-center">
        <a href="{{asset('sample-students.xlsx')}}" download="sample-students.xlsx" class="btn btn-danger">Download Sample Excel File</a>
    </div>
